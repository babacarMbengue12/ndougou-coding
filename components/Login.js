    ...
    <View style={{flex: 1,backgroundColor: "#E5E5E5"}}>
      <View style={{alignItems: "center",marginTop: 74}}>
       ...
       <View style={{padding: 30}}>
           ...
           <TouchableOpacity>
           <Text style={{color: "#001F34"}}>Mot de passe oublié ?</Text></TouchableOpacity>
           </View>
        ...
        <TouchableOpacity onPress={()=> navigation.navigate('LoginPhone')}  style={{height: 57,width: "100%",backgroundColor: "transparent",justifyContent: "center",alignItems: "center",borderRadius: 7,marginTop: 18,borderWidth: 2,borderColor: "#11BD9E"}}>
          <Text style={{color: "#000"}}>Se connecter avec un numéro</Text>
        </TouchableOpacity>
